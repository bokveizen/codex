...
impl Session {
    ...
    fn resolve_turn_environments(
        ...
        session_configuration: &SessionConfiguration,
        environment_selections: Option<Vec<TurnEnvironmentSelection>>,
    ) -> ConstraintResult<Vec<TurnEnvironment>> {
    ...
    async fn new_turn_from_configuration(
        ...
        let model_info = self
            ...
            .await;
        let default_environment = turn_environments.first();
        let cwd = default_environment
        ...
        let fs = default_environment.map(|environment| environment.get_filesystem());
