...
- `cwd` — restrict results to threads whose session cwd exactly matches one of these paths. Relative paths are resolved against the app-server process cwd before matching.
